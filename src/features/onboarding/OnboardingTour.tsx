import { ArrowLeft, ArrowRight, Bot, FolderKanban, LayoutDashboard, Lightbulb, ListTodo, Settings, Sparkles, Timer, X } from 'lucide-react'
...
const steps: TourStep[] = [
  ...
  {
    eyebrow: 'PASO 5 · ASISTENTE Y AJUSTES',
